...
from litdatamatcher.acquisition_v2 import audit_offline_recovery, run_numeric_alignment, sync_datasets, sync_literature


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--root", type=Path, required=True)
    parser.add_argument("--stage", choices=["literature", "datasets", "integrate", "audit-offline", "all"], default="all")
