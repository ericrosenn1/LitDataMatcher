...
def test_planner_selects_only_complete_cached_eligible_source():
    sources=[{"name":"good","supported":True,"modalities":["proteomics"],"access":"public","license":"CC0","terms_context":"fixture","metadata_completeness":"OBSERVED","offline_cache_available":True,"candidate_universe_status":"COMPLETE_CANDIDATE_UNIVERSE"},{"name":"partial","supported":True,"modalities":["proteomics"],"access":"public","license":"CC0","terms_context":"fixture","metadata_completeness":"OBSERVED","offline_cache_available":True,"candidate_universe_status":"PARTIAL_CANDIDATE_UNIVERSE_NOT_EVIDENCE_COMPLETE"}]
